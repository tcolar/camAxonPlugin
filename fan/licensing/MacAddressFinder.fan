...
@NoDoc
internal class MacAddressFinder
{
  ...
  ** Find all mac addresses
  MacAddress[] findAll()
  {
    ...
    {
      echo(e) // rather not give too much details here
    }
    payload := buf.flip.readAllStr
...
** Unit tests for this
@NoDoc
internal class MacAddressFinderTest : Test
{
  Void test()
  {
